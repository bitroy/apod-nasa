        ...
        return (
            <div className={styles.container}>
                {this.state.errormsg === null ? (
                    <>
                        <div className={styles.showhdimagebtn}>
                            {this.state.showhd ? <button onClick={this.showHDImage}>Show Plain Image</button> :
                                <button onClick={this.showHDImage}>Show HD Image</button>}
                        </div>
                        {this.state.showhd ?
                            <img src={this.state.hdurl} alt={this.state.title} data-testid="apod-image"/>
